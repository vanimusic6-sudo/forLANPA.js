(function () {
    ...
    var SETTINGS_FLAG = 'sw_settings_ready_v49';
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dossier{position:relative;background:linear-gradient(160deg,#363c3f,#2b3134);border:1px solid rgba(255,255,255,.05);border-radius:24px;padding:34px 40px;margin-bottom:22px;box-shadow:0 6px 18px rgba(0,0,0,.25);animation:swRise .55s cubic-bezier(.22,1,.36,1) both}' +
            ...
            '.sw-dicebtn{position:relative;display:block;width:100%;height:110px;background:linear-gradient(135deg,#a8aaad,#939599);border:none;border-radius:14px;margin:0 0 22px;overflow:hidden;cursor:pointer;outline:none;-webkit-tap-highlight-color:transparent;box-shadow:0 4px 12px rgba(0,0,0,.2);transition:background .3s ease,transform .3s ease}' +
            '.sw-dicebtn.focus{background:linear-gradient(135deg,#b9bbbe,#a4a6aa);transform:translateY(-2px)}' +
            '.sw-label-wrap{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;padding:0 90px 0 110px;overflow:hidden}' +
            '.sw-label{font-family:' + COND + ';font-size:2.35em;font-weight:700;color:#43464a;text-transform:lowercase;letter-spacing:.02em;text-align:center;white-space:nowrap;opacity:1;transition:opacity .35s ease}' +
            '.sw-label.hidden{opacity:0}' +
            '.sw-label.res-yes{color:#1b5e20}.sw-label.res-no{color:#b71c1c}' +
            '.sw-dice{position:absolute;left:18px;top:50%;width:64px;height:64px;margin-top:-32px;will-change:transform;transition:left .5s cubic-bezier(.3,.7,.4,1),margin-left .5s cubic-bezier(.3,.7,.4,1)}' +
            '.sw-dice svg{width:100%;height:100%;display:block;transform:rotate(-8deg)}' +
            '.sw-dicebtn.spinning .sw-dice{left:50%;margin-left:-32px;transition:left .45s cubic-bezier(.22,1,.36,1),margin-left .45s cubic-bezier(.22,1,.36,1)}' +
            '.sw-dicebtn:not(.spinning) .sw-dice{transition:left .55s cubic-bezier(.34,1.3,.44,1),margin-left .55s cubic-bezier(.34,1.3,.44,1)}' +
            '.sw-dice.sw-spin{animation:swSpin 1s cubic-bezier(.35,.6,.3,1) forwards}' +
            '@keyframes swSpin{0%{transform:translateY(0) rotate(0) scale(1)}12%{transform:translateY(-6px) rotate(80deg) scale(1.12,.9)}30%{transform:translateY(0) rotate(240deg) scale(.96,1.08)}50%{transform:translateY(-8px) rotate(400deg) scale(1.1,.94)}70%{transform:translateY(0) rotate(560deg) scale(.98,1.05)}88%{transform:translateY(-3px) rotate(680deg) scale(1.04)}100%{transform:translateY(0) rotate(720deg) scale(1)}}' +
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v49.0 (bigger label, physics dice, auto-height cols)');
    }
