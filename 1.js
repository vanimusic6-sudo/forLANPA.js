(function () {
    ...
    var SETTINGS_FLAG = 'sw_settings_ready_v44';
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dicebtn{position:relative;display:block;width:100%;height:100px;background:#eef1f3;border:none;border-radius:14px;margin:0 0 22px;overflow:hidden;cursor:pointer;outline:none;-webkit-tap-highlight-color:transparent;transition:width .45s cubic-bezier(.22,1,.36,1),border-radius .45s ease,margin .45s cubic-bezier(.22,1,.36,1)}' +
            '.sw-dicebtn.focus{box-shadow:0 0 0 3px rgba(255,255,255,.7)}' +
            '.sw-dicebtn.morph{width:120px;margin-left:auto;margin-right:auto;border-radius:24px}' +
            ...
            '.sw-dice{position:absolute;left:16px;top:50%;width:70px;height:70px;margin-top:-35px;will-change:transform;transition:left .45s cubic-bezier(.22,1,.36,1),margin-left .45s cubic-bezier(.22,1,.36,1)}' +
            '.sw-dice svg{width:100%;height:100%;display:block;transform:rotate(-8deg)}' +
            '.sw-dicebtn.morph .sw-dice{left:50%;margin-left:-35px}' +
            '.sw-dice.sw-spin{animation:swSpin 1s cubic-bezier(.3,.6,.3,1) forwards}' +
            '@keyframes swSpin{0%{transform:rotate(0) scale(1)}50%{transform:rotate(360deg) scale(1.15)}100%{transform:rotate(720deg) scale(1)}}' +
            ...
            '@media(max-width:640px){.sw-modal-content{padding:18px 18px 34px}.sw-columns{grid-template-columns:1fr}.sw-verdict-word{font-size:2em}.sw-label{font-size:1.4em}.sw-label-wrap{padding:0 84px}.sw-dice{width:56px;height:56px;margin-top:-28px;left:12px}.sw-dicebtn.morph .sw-dice{margin-left:-28px}}';
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v44.0 (morph dice anim, smaller font)');
    }
