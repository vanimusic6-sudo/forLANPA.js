(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-modal-content{padding:28px 32px 48px;color:#e9ebeb;font-family:' + DISPLAY + ';font-size:20px;box-sizing:border-box;max-height:88vh;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;touch-action:pan-y;animation:swModalIn .42s cubic-bezier(.22,1,.36,1) both;transform-origin:50% 8%}' +
            '@keyframes swModalIn{from{opacity:0;transform:translateY(10px) scale(.985);filter:blur(2px)}to{opacity:1;transform:translateY(0) scale(1);filter:blur(0)}}' +
            ...
            '.sw-dossier{position:relative;background:linear-gradient(160deg,rgba(44,47,50,.94),rgba(30,32,35,.9));border:1px solid rgba(255,255,255,.07);border-radius:24px;padding:34px 40px;margin-bottom:22px;box-shadow:0 10px 28px rgba(0,0,0,.35),inset 0 1px 0 rgba(255,255,255,.05);overflow:hidden;animation:swRise .5s cubic-bezier(.22,1,.36,1) both}' +
            '.sw-dossier::after{content:"";position:absolute;inset:-40% -20%;background:linear-gradient(105deg,transparent 35%,rgba(255,255,255,.055) 47%,rgba(255,255,255,.10) 50%,transparent 62%);transform:translateX(-80%) rotate(3deg);pointer-events:none;animation:swDossierSweep 1.1s cubic-bezier(.22,1,.36,1) .25s 1 both}' +
            '@keyframes swDossierSweep{to{transform:translateX(80%) rotate(3deg)}}' +
            ...
            '.sw-verdict-word{font-family:' + COND + ';font-size:3em;font-weight:700;letter-spacing:.02em;line-height:1;margin:0 0 24px;text-transform:uppercase;opacity:0;transform:translateY(6px);transition:opacity .5s cubic-bezier(.22,1,.36,1),transform .5s cubic-bezier(.22,1,.36,1);text-shadow:0 2px 14px rgba(0,0,0,.25),0 4px 24px rgba(0,0,0,.15)}' +
            '.sw-verdict-word.appear{opacity:1;transform:translateY(0)}' +
            '.sw-verdict-word.yes{color:#8bab74;text-shadow:0 2px 14px rgba(139,171,116,.45),0 4px 24px rgba(0,0,0,.15)}' +
            '.sw-verdict-word.no{color:#c47b83;text-shadow:0 2px 14px rgba(196,123,131,.45),0 4px 24px rgba(0,0,0,.15)}' +
            '.sw-verdict-word.maybe{color:#c99968;text-shadow:0 2px 14px rgba(201,153,104,.45),0 4px 24px rgba(0,0,0,.15)}' +
            '.sw-meter{height:5px;border-radius:3px;background:rgba(255,255,255,.08);overflow:hidden;position:relative;margin:14px 0 4px}' +
            '.sw-meter-fill{height:100%;width:0;transition:width 1s cubic-bezier(.22,1,.36,1);position:relative;overflow:hidden}' +
            '.sw-meter-fill::after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,transparent,rgba(255,255,255,.25),transparent);transform:translateX(-100%);animation:swMeterSheen 1.6s ease-out .4s 1}' +
            ...
            '.sw-dicebtn::after{content:"";position:absolute;inset:0;background:linear-gradient(110deg,transparent 25%,rgba(255,255,255,.16) 42%,rgba(255,255,255,.04) 52%,transparent 68%);transform:translateX(-120%);pointer-events:none}' +
            '.sw-dicebtn:hover{transform:translateY(-2px) scale(1.006);box-shadow:0 12px 28px rgba(0,0,0,.34),inset 0 1px 0 rgba(255,255,255,.28)}' +
            '.sw-dicebtn:hover::after,.sw-dicebtn.focus::after{animation:swButtonSheen .8s cubic-bezier(.22,1,.36,1) 1}' +
            '@keyframes swButtonSheen{to{transform:translateX(120%)}}' +
            '.sw-dicebtn:active{transform:translateY(0) scale(.996)}' +
            '.sw-dicebtn.focus{box-shadow:0 0 0 3px rgba(255,255,255,.35),0 8px 22px rgba(0,0,0,.28)}' +
            '.sw-dice-spin{animation:swDiceRollPremium 1.45s cubic-bezier(.16,.82,.24,1) 1}' +
            '@keyframes swDiceRollPremium{0%{transform:translateY(0) rotate(0deg) scale(1)}12%{transform:translateY(-2px) rotate(75deg) scale(1.025)}27%{transform:translateY(-7px) rotate(190deg) scale(1.075)}43%{transform:translateY(-10px) rotate(335deg) scale(1.11)}58%{transform:translateY(-5px) rotate(500deg) scale(1.08)}73%{transform:translateY(-2px) rotate(635deg) scale(1.045)}87%{transform:translateY(0) rotate(700deg) scale(1.015)}100%{transform:translateY(0) rotate(720deg) scale(1)}}' +
            '.sw-label-wrap{position:absolute;top:0;left:0;right:0;bottom:0;display:flex;align-items:center;justify-content:center;padding:0;overflow:hidden;pointer-events:none}' +
            '.sw-label{font-family:' + COND + ';font-weight:700;color:#43464a;text-transform:lowercase;text-align:center;white-space:nowrap;opacity:0;transform:scale(.95);transition:opacity .28s cubic-bezier(.22,1,.36,1),transform .28s cubic-bezier(.22,1,.36,1);letter-spacing:-.02em;pointer-events:none}' +
            '.sw-label.show{opacity:1;transform:scale(1);pointer-events:auto}' +
            '.sw-label.res-yes{color:#40512f}.sw-label.res-no{color:#4e2830}' +
            '#sw-dice{position:absolute;left:18px;top:50%;width:70px;height:70px;margin-top:-35px;display:flex;align-items:center;justify-content:center;opacity:0;pointer-events:none;transition:opacity .28s cubic-bezier(.22,1,.36,1)}' +
            '#sw-dice.show{opacity:1;pointer-events:auto}' +
            '#sw-dice-face{width:100%;height:100%;display:block;transition:opacity .12s ease,transform .12s cubic-bezier(.22,1,.36,1);transform-origin:50% 50%}' +
            ...
            '.sw-col{position:relative;background:linear-gradient(160deg,rgba(42,45,48,.92),rgba(28,30,33,.88));border:1px solid rgba(255,255,255,.05);border-radius:10px;padding:24px 28px 24px calc(13% + 28px);box-shadow:0 6px 16px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.04);transition:transform .28s cubic-bezier(.22,1,.36,1),border-color .28s ease,box-shadow .28s ease}' +
            '.sw-col:hover{transform:translateY(-2px);border-color:rgba(255,255,255,.09);box-shadow:0 10px 24px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.045)}' +
            ...
            '@media(prefers-reduced-motion:reduce){.sw-modal-content,.sw-dossier,.sw-dossier::after,.sw-dice-spin,.sw-dicebtn::after,.sw-meter-fill::after{animation:none !important}.sw-dicebtn,.sw-col,.sw-label,.sw-verdict-word,.sw-list li,#sw-dice,#sw-dice-face{transition:none !important}}' +
    ...
    function restorePrevAfterClose() {
        if (window._sw_restoreTimer) {
            clearTimeout(window._sw_restoreTimer);
            window._sw_restoreTimer = null;
        }
    ...
    function finishModalClose(fromController) {
        var closing = !!fromController || window._sw_closingFromController;

        cleanupModal();

        window._sw_closingFromController = false;

        restorePrevAfterClose();
    }
    ...
    function bindDice(html, cfg) {
        ...
        function scheduleSwap(){
            faceTimer = setTimeout(function(){
                if (stopCycle) return;
                if (Date.now() - startTime > 1150) return;
                var f; do { f = rndFace(); } while (f === currentFace);
                currentFace = f;
                dice.style.opacity = '0';
                dice.style.transform = 'scale(.90) rotate(4deg)';
                setTimeout(function(){
                    if (stopCycle) return;
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v66.0 (premium focus fix, dice animation, sweep UI)');
    }
