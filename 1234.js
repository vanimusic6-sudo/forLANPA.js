(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '@media(max-width:640px){.sw-modal-content{padding:20px 18px 36px}.sw-columns{grid-template-columns:1fr}.sw-col{padding:20px 22px 20px calc(16% + 22px)}.sw-col::before{width:16%}.sw-verdict-word{font-size:2.2em}.sw-label-wrap{padding:0 20px 0 92px}#sw-dice{width:56px;height:56px;margin-top:-28px;left:14px}}';
    ...
    function bindDice(html, cfg) {
        ...
        // Применяем отдельный размер текста плашки
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v65.0 (separate dice text size)');
    }
