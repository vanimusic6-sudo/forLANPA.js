(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dice-core{display:block;width:100%;height:100%;will-change:transform}' +
            ...
            '.sw-dice.sw-run .sw-dice-core{animation:swRot 1.6s linear forwards}' +
            '.sw-dice.sw-run .sw-dice-core svg{animation:swSquash 1.6s cubic-bezier(.4,0,.6,1) forwards}' +
            ...
            '@keyframes swRot{from{transform:rotate(0)}to{transform:rotate(720deg)}}' +
            '@keyframes swSquash{0%,22%,78%,100%{transform:rotate(-8deg) scale(1,1)}30%{transform:rotate(-8deg) scale(.94,1.06)}42%{transform:rotate(-8deg) scale(1.07,.93)}54%{transform:rotate(-8deg) scale(.97,1.04)}66%{transform:rotate(-8deg) scale(1.04,.96)}}' +
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v52.0 (layered smooth dice)');
    }
