(function () {
    ...
    // ======================================================================
    // CSS РЯДА КАРТОЧЕК (обложку НЕ трогаем — ряд встаёт под всю шапку)
    // ======================================================================
    function injectCSS() {
    ...
    // ======================================================================
    // DOM-СИГНАЛЫ И ЛОКАЛЬНЫЕ ДАННЫЕ ЛАМПЫ
    // ======================================================================
    ...
    // ======================================================================
    // РИСУНКИ КАРТОЧЕК — векторные, перерисованы с эскизов точь-в-точь
    // (лесенки сглажены, все детали сохранены). Сетка 400x300.
    // ======================================================================
    ...
    /* «ВОЙНА» — поваленный ящик, лужа крови с алой кромкой, белое слово */
    function artWar() {
        var t = swBg('#1e2121');
    ...
    /* «СТРАХ» — тесак с ремешком, капающее слово, глаз, пластырь, царапины */
    function artFear() {
        var t = swBg('#202327');
    ...
    /* «НАРК.» — лежачий шприц (игла влево, капли у кончика), белое слово */
    function artDrugs() {
        var t = swBg('#202124');
    ...
    /* «РЕАЛЬНЫЕ СОБЫТИЯ» — карточка-камера: объектив, красная точка записи */
    function artReal() {
        var t = swBg('#101214');
    ...
    /* «РАЗБОЙ И КРИМИНАЛ» — наручники с цепочкой */
    function artCrime() {
        var t = swBg('#2b2e33');
    ...
    /* «ПОДХОДИТ ДЛЯ ДЕТЕЙ» — бурая плашка-мишка: глаза вниз, пунктир-следы */
    function artKids() {
        var t = swBg('#b5772f'), i;
    ...
    // ======================================================================
    // КАКАЯ КАРТОЧКА КОГДА ВЫВОДИТСЯ (только отрисованные)
    // ======================================================================
    var CARD_SLOTS = 6;
    var SW_CUSTOM_CARDS = [
    ...
    // ======================================================================
    // РЕНДЕР РЯДА (ряд — ПОД всей шапкой, обложка не трогается)
    // ======================================================================
        ...
        try {
            ...
            analyze(movie).then(function(result) {
                ...
                cards.forEach(function(c){
                    row.append($('<div class="sw-card"></div>').attr('title', c.title).html(svgWrap(c.svg)));
                });
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v69.0-cards (новые эскизы: война/нарк/страх/дети/события)');
    }
