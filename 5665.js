(function () {
    ...
    var SW_BG = '#26282c'; // единый глубокий серый фон для рисованных карточек
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            '.sw-cards-row{display:flex;gap:16px;margin:-60px 0 26px;padding:6px 0 10px}' +
            ...
            '.sw-card{flex:0 0 auto;width:340px;aspect-ratio:4/3;border-radius:30px;overflow:hidden;position:relative;background:transparent;border:none}' +
            '.sw-card svg{position:absolute;inset:0;width:100%;height:100%;display:block}' +
            '@media(max-width:640px){.sw-card{width:240px}}';
    ...
    /* «РАЗБОЙ» — трассированный SVG (фон перекрасится в единый серый) */
    ...
    /* «ДЕТИ» — новый трассированный SVG */
    function artKids() {
        return '<svg viewBox="0 0 838 845" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">' +
        '<g><path fill="#ffffff" stroke="#ffffff" stroke-width="0.5" d="M 0,0 c 279.33,0 558.67,0 838,0 c 0,281.67 0,563.33 0,845 c -279.33,0 -558.67,0 -838,0 c 0,-281.67 0,-563.33 0,-845 Z M 130.93,583.13 c 0.28,0.43 0.67,0.71 1.17,0.84 c 0.04,0.57 0.34,0.94 0.9,1.08 c 1.05,0.63 2.07,1.32 3.04,2.07 c 0.09,0.5 0.38,0.78 0.88,0.85 c 0.71,0.38 1.43,0.73 2.16,1.06 c 0.04,0.56 0.34,0.89 0.9,0.98 c 0.67,0.36 1.35,0.68 2.04,0.99 c 0.06,0.6 0.39,0.92 0.99,0.95 c 0.36,0.02 0.71,0.03 1.06,0.04 c 0.07,0.53 0.36,0.87 0.88,1 c 0.7,0.35 1.38,0.71 2.07,1.08 c 0.12,0.54 0.47,0.85 1.02,0.91 c 0.34,0.02 0.68,0.04 1.01,0.06 c -0.01,0.6 0.29,0.91 0.89,0.92 c 0.35,0.01 0.7,0.02 1.05,0.03 c 0.06,0.58 0.37,0.9 0.95,0.95 c 0.34,0.05 0.68,0.1 1.02,0.15 c 0.08,0.62 0.43,0.91 1.06,0.87 c 0.32,0.02 0.63,0.04 0.95,0.07 c 0.4,0.84 1.07,1.16 2.03,0.96 c 0.34,0.02 0.69,0.03 1.04,0.04 c 0.06,0.55 0.36,0.88 0.9,0.99 c 0.34,0.01 0.67,0.02 1.01,0.03 c 0.39,0.92 1.1,1.23 2.12,0.92 c 0.29,0.01 0.58,0.03 0.88,0.04 c 0.37,0.88 1.04,1.21 2.02,0.98 c 0.37,0 0.73,0 1.09,0.01 c 0.27,0.92 0.91,1.26 1.91,1.01 c 0.32,0.01 0.64,0.02 0.96,0.03 c -0.08,1.44 2.25,0.92 3.1,0.96 c -0.18,1.44 2.11,0.98 2.93,0.99 c 0.35,0.01 0.7,0.02 1.06,0.03 c -0.38,1.73 3.99,0.74 4.9,1.01 c 0.38,0.01 0.76,0.03 1.14,0.04 c -0.31,1.59 4.04,0.72 4.92,0.96 c 0.32,0.02 0.64,0.04 0.95,0.05 c 0.22,0.75 0.73,1.07 1.54,0.97 c 4.17,-0.06 8.34,-0.07 12.51,-0.01 c 0.19,0.75 0.69,1.09 1.49,1.01 c 131.67,-0.03 263.33,-0.06 395,-0.11 c 0.42,-0.16 0.56,-0.44 0.43,-0.86 c 0.33,-0.05 0.67,-0.09 1.01,-0.13 c 4.51,0.08 9.01,0.07 13.51,-0.05 c 0.4,-0.16 0.6,-0.45 0.58,-0.87 c 2.16,-0.01 4.31,-0.05 6.46,-0.1 c 0.42,-0.18 0.61
9.64 -6.3,14.57 c -3.77,-1.44 -5.45,3.33 -1.89,4.75 c -9.64,17.91 -32.17,7.61 -46.17,1.66 c -28.56,-11.81 -57.13,-23.59 -85.71,-35.34 c -9.92,-4.42 -19.2,-12.07 -19.8,-23.67 c 7.38,-20.28 16.76,-41.05 24.75,-61.25 c 7.82,-15.91 29.65,-8.38 42.01,-2.99 c 0.81,0.26 1.63,0.35 2.48,0.27 Z M 494.7,580.85 c 0.64,-1.82 0.09,-3.12 -1.66,-3.92 c -2.4,-7.36 -4.85,-14.7 -7.36,-22.04 c 0.5,-1.39 0.23,-2.6 -0.81,-3.65 c -1.88,-6.54 -3.89,-13.05 -6.02,-19.52 c 1.92,-2.59 1.29,-4.18 -1.87,-4.77 c -1.02,-8.27 -3.56,-9.37 0.04,-18.28 c 8.99,-9.57 18.1,-13.14 30.98,-15.7 c 1.88,0.41 3.21,-0.23 4.01,-1.93 c 8.12,-2.09 16.17,-4.45 24.14,-7.09 c 10.34,-3.16 20.71,-6.23 31.09,-9.23 c 0.34,-0.14 0.59,-0.39 0.73,-0.72 c 2.68,-0.3 11.53,-2.78 14.17,-4.16 c 7.24,-1.99 14.47,-3.98 21.71,-5.97 c 18.13,-2.43 26.2,-0.36 30.86,17.91 c 3.37,15.61 14.77,40.45 13.97,55.45 c -5.12,9.8 -13.67,13.74 -23.7,17.23 c -37.25,10.47 -73.92,23.76 -111.59,32.36 c -6.74,0.25 -13.45,-1.65 -18.69,-5.97 Z"/></g>' +
        '<g><path fill="#171717" stroke="#171717" stroke-width="0.5" d="M 336.98,302.98 c 0.41,-1.26 1.27,-1.86 2.59,-1.78 c 4.91,-0.11 39.37,-2.26 39.41,2.3 c -0.1,1.6 -0.95,2.36 -2.55,2.3 c -12.6,0.28 -25.19,0.25 -37.79,-0.08 c -1.17,-0.5 -1.73,-1.42 -1.66,-2.74 Z"/></g>' +
        '</svg>';
    }
    ...
    function artDrugs() {
        ...
        t += '<ellipse cx="112" cy="0" rx="12" ry="26" fill="#3f444a"/><ellipse cx="112" cy="0" rx="5" ry="14" fill="' + SW_BG + '"/>';
        t += '</g>';
    ...
    function artCrime() {
        ...
        t += swText(200, 172, 90, '#f5f5f5', 'разбой', 'textLength="350" lengthAdjust="spacingAndGlyphs"');
        return t + swText(170, 218, 40, '#c7c7c7', 'и криминал');
    }

    // ======================================================================
    // ФИКС v72: трассированные SVG не вырезают белый слой (он держит белые
    // буквы/глаза), viewBox кадрирует по рисунку, preserveAspectRatio=none
    // растягивает в карточку; у «разбой» фон перекрашен в единый серый.
    // ======================================================================
    function swClean(s, vb) {
        s = s.replace('preserveAspectRatio="xMidYMid meet"', 'preserveAspectRatio="none"');
        if (vb) s = s.replace('viewBox="0 0 838 845"', 'viewBox="' + vb + '"');
        return s;
    }
    (function () {
        var tracedHumor = artHumor, tracedRazboy = artHeritage, tracedSex = artSex, tracedKids = artKids;
        artHumor = function(){ return swClean(tracedHumor(), '141 246 510 372'); };
        artSex   = function(){ return swClean(tracedSex(),   '138 243 460 374'); };
        artCrime = function(){ return swClean(tracedRazboy(), '136 274 603 400').replace(/#121212/g, SW_BG); };
        artKids  = function(){ return swClean(tracedKids(),  '118 174 552 426'); };
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v72.0 (белые буквы разбой, единый серый фон, новые дети)');
    }
