(function () {
    ...
    var SETTINGS_FLAG = 'sw_settings_ready_v59';
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            /* Анимация полёта с возвратом */
            '#sw-dice.sw-run{animation:rollAction 1.6s cubic-bezier(0.2,0.8,0.2,1) forwards}' +
            '@keyframes rollAction{0%{transform:translate3d(0,0,0) rotate(0deg) scale(1)}40%{transform:translate3d(calc(var(--sw-dist)*0.6),-15px,0) rotate(360deg) scale(1.1)}80%{transform:translate3d(var(--sw-dist),0,0) rotate(720deg) scale(1)}100%{transform:translate3d(0,0,0) rotate(720deg) scale(1)}}' +
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v59.0 (premium dice, bugfree)');
    }
