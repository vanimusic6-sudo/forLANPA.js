(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dicebtn.focus{box-shadow:0 0 0 4px rgba(185,138,94,.55),0 6px 16px rgba(0,0,0,.28)}' +
    ...
    function showModal(movie) {
        try {
            ...
            window._sw_loaderTimer = setInterval(function(){
                dots = (dots + 1) % 4;
                if (dots === 0) pi = (pi + 1) % phases.length;
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v65.2 (refined UI, tuned dictionaries, bounded network waits)');
    }
