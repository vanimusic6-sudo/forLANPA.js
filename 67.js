(function () {
    ...
    var SETTINGS_FLAG = 'sw_settings_ready_v61';
    ...
    function bindDice(html) {
        ...
        btnJ.on('click hover:enter keydown', function(e) {
            ...
            try {
                ...
                // Запускаем тряску кнопки
                btnJ.removeClass('shaking');
                void btn.offsetWidth;
                btnJ.addClass('shaking');

                // Быстро меняем грани во время тряски
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v61.0 (shaking button, simple dice)');
    }
