(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-card{flex:0 0 auto;width:296px;aspect-ratio:4/3;border-radius:18px;overflow:hidden;position:relative;background:#14161a;border:none}' +
    ...
    /* «ЮМОР» — ВСТАВКА ТВОЕГО SVG (точь-в-точь) */
    function artHumor() {
    ...
    /* «ДОСТОЯНИЕ ЖАНРА» — ВСТАВКА ТВОЕГО SVG (точь-в-точь) */
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v70.0-user-svg (юмор/достояние/sex — трассированные SVG)');
    }
