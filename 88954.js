...
(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-columns{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:20px;align-items:stretch}' +
    ...
    // Safe fallbacked movie accessor
    ...
    function swScrollToFocus(targetEl, center) {
        ...
        try {
            ...
            // Smooth easeInOutCubic animation with cancelAnimationFrame to prevent leaks
    ...
    // Complete Memory-Safe Modal Cleanup (Document specifications)
    ...
    function bindDice(html) {
        ...
        $(btn).on('hover:enter click keydown', function(e){
            ...
            // Strict Binary Logic: only 'СТОИТ' or 'НЕ СТОИТ' (no 'СПОРНО')
