(function () {
    ...
    // Прекомпилированные регулярки (оптимизация)
            ...
            try {
                ...
                var iv = setInterval(function(){
                    ...
                    if (p >= 1) {
                        ...
                        // Текст появляется когда кубик докрутился
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v38.0 (clean: no badges, dice text fix, optimized)');
    }
