(function () {
    ...
    var SETTINGS_FLAG = 'sw_settings_ready_v42';
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-body{animation:swFadeIn .35s ease-out}' +
            ...
            '.sw-loader-emoji{font-size:3em;line-height:1}' +
            ...
            '.sw-dossier{position:relative;background:#212529;border-radius:14px;padding:28px 30px;margin-bottom:20px;animation:swFadeIn .35s ease-out both}' +
            ...
            '.sw-verdict-word{font-size:2.6em;font-weight:800;letter-spacing:.02em;line-height:1;margin:0 0 18px;text-transform:uppercase;opacity:0;transition:opacity .4s ease-out}' +
            ...
            '.sw-meter-fill{height:100%;width:0;border-radius:2px;transition:width .8s ease-out}' +
            ...
            '.sw-label{font-family:' + DISPLAY + ';font-size:2em;font-weight:800;color:#8a9096;letter-spacing:.02em;text-align:center;white-space:nowrap;opacity:1;transition:opacity .2s ease-out}' +
            ...
            '.sw-dice.sw-rolling{animation:swRollFull 1.5s cubic-bezier(.3,.5,.3,1) forwards}' +
            ...
            '.sw-list li{margin-bottom:10px;opacity:0;transition:opacity .35s ease-out}' +
    ...
    function bindDice(html) {
        ...
        $(btn).on('hover:enter click keydown', function(e){
            try {
                ...
                var t0 = Date.now(), DUR = 1500, frame = 0;
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v42.0 (settings fix, paint font sizes, smooth anims)');
    }
