(function () {
    ...
    /* ===== ЦЕЛЬНЫЕ SVG-КАРТОЧКИ (точь-в-точь) ===== */
    var ART_GENRE = '<svg viewBox="0 0 310 250" class="sw-art"><rect x="3" y="3" width="304" height="244" rx="42" fill="#2b2d30" stroke="#141414" stroke-width="5"/><g transform="rotate(-10 90 70)"><rect x="52" y="28" width="76" height="92" fill="#7a1f2b" stroke="#8a5a1f" stroke-width="7"/><circle cx="90" cy="58" r="15" fill="#e8c39a"/><path d="M68 116 q4 -24 22 -24 q18 0 22 24 z" fill="#2f7d46"/></g><rect x="150" y="66" width="70" height="76" fill="#0c0d0c" stroke="#3a3a10" stroke-width="5" transform="rotate(6 185 104)"/><text x="232" y="105" font-family="' + FONT + '" font-style="italic" font-weight="700" font-size="26" fill="#8a8d92" text-anchor="middle">достояние</text><text x="155" y="152" font-family="' + FONT + '" font-weight="800" font-size="80" fill="#8a8d92" text-anchor="middle">жанр</text></svg>';
    var ART_WAR = '<svg viewBox="0 0 310 250" class="sw-art"><defs><clipPath id="wclip"><rect x="3" y="3" width="304" height="244" rx="42"/></clipPath></defs><rect x="3" y="3" width="304" height="244" rx="42" fill="#333d1c" stroke="#141808" stroke-width="5"/><g clip-path="url(#wclip)"><ellipse cx="60" cy="60" rx="40" ry="26" fill="#8a9a3a"/><ellipse cx="55" cy="55" rx="36" ry="22" fill="#5a6b4a"/><ellipse cx="160" cy="45" rx="42" ry="26" fill="#8a9a3a"/><ellipse cx="155" cy="42" rx="38" ry="22" fill="#5a6b4a"/><ellipse cx="255" cy="60" rx="40" ry="26" fill="#8a9a3a"/><ellipse cx="250" cy="56" rx="36" ry="22" fill="#5a6b4a"/><ellipse cx="90" cy="150" rx="44" ry="28" fill="#8a9a3a"/><ellipse cx="85" cy="146" rx="40" ry="24" fill="#5a6b4a"/><ellipse cx="210" cy="150" rx="46" ry="28" fill="#8a9a3a"/><ellipse cx="205" cy="146" rx="42" ry="24" fill="#5a6b4a"/><ellipse cx="120" cy="210" rx="40" ry="24" fill="#8a9a3a"/><ellipse cx="250" cy="205" rx="40" ry="24" fill="#5a6b4a"/></g><text x="155" y="152" font-family="' + FONT + '" font-weight="800" font-size="80" fill="#0d0f0c" text-anchor="middle">война</text></svg>';
    var ART_HUMOR = '<svg viewBox="0 0 310 250" class="sw-art"><rect x="3" y="3" width="304" height="244" rx="42" fill="#202226" stroke="#101112" stroke-width="5"/><circle cx="62" cy="48" r="52" fill="#f5c31c"/><circle cx="48" cy="38" r="11" fill="#0d0f0c"/><circle cx="52" cy="34" r="4" fill="#fff"/><circle cx="78" cy="38" r="11" fill="#0d0f0c"/><circle cx="82" cy="34" r="4" fill="#fff"/><path d="M40 66 q22 14 44 0 l-4 9 q-18 10 -36 0 z" fill="#fff" stroke="#0d0f0c" stroke-width="4"/><g fill="#7ec2e8"><circle cx="30" cy="56" r="4"/><circle cx="27" cy="66" r="4"/><circle cx="92" cy="52" r="4"/><circle cx="96" cy="61" r="4"/></g><text x="172" y="152" font-family="' + FONT + '" font-weight="800" font-size="72" fill="#f5c31c" text-anchor="middle">юмор</text></svg>';
    var ART_FEAR = '<svg viewBox="0 0 310 250" class="sw-art"><rect x="3" y="3" width="304" height="244" rx="42" fill="#26282b" stroke="#3a3d42" stroke-width="5"/><rect x="196" y="18" width="86" height="20" rx="6" fill="#7a4a1f" transform="rotate(6 239 28)"/><rect x="272" y="12" width="16" height="30" rx="5" fill="#5d3817" transform="rotate(6 280 27)"/><path d="M282 44 q20 12 14 34 q-3 12 6 18" stroke="#5d3817" stroke-width="5" fill="none" stroke-linecap="round"/><path d="M150 26 L232 18 L238 66 L156 76 Z" fill="#4a4d52"/><rect x="150" y="24" width="86" height="8" fill="#8a8d92"/><path d="M146 66 q40 -14 82 4 q22 9 17 29 q-5 20 -26 24 q-33 7 -56 -4 q-24 -12 -17 -30 z" fill="#7a0d1a"/><text x="155" y="142" font-family="' + FONT + '" font-weight="800" font-size="80" fill="#8a0f1e" text-anchor="middle">страх</text></svg>';
    var ART_TRUE = '<svg viewBox="0 0 310 250" class="sw-art"><rect x="3" y="3" width="304" height="244" rx="42" fill="#4a4750" stroke="#101112" stroke-width="5"/><g transform="rotate(-12 250 55)"><rect x="212" y="26" width="86" height="66" rx="16" fill="#26282b"/><circle cx="255" cy="59" r="20" fill="#0d0f0c"/><rect x="278" y="16" width="12" height="12" fill="#0d0f0c"/></g><text x="155" y="108" font-family="' + FONT + '" font-style="italic" font-weight="700" font-size="28" fill="#0d0f0c" text-anchor="middle">реальные</text><text x="155" y="152" font-family="' + FONT + '" font-weight="800" font-size="64" fill="#0d0f0c" text-anchor="middle">события</text></svg>';
    ...
    function buildRow(a) {
        ...
        var cards = '<div class="sw-plaque sw-plaque--verdict" style="animation-delay:' + (idx++ * 0.07).toFixed(2) + 's">' +
            '<div class="sw-plaque-text" style="color:' + vColor + '"><span class="sw-plaque-word">' + esc(a.v
