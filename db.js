 ...
 * Version: 54.0 (Design v53 + v50 blocknav: highlightVisible, scrollStep with animate, keydown capture, TV detect)
...
(function () {
    ...
    function injectCSS() {
        ...
        if (document.getElementById('sw-plugin-styles-v54x')) return;
        var s = document.createElement('style');
        s.id = 'sw-plugin-styles-v54x';
        s.innerHTML =
    ...
    function getScrollContainer() {
        ...
        var inner = h.find('.sw-wrap')[0] || h[0];
    ...
    function registerController() {
        try {
            ...
            Lampa.Controller.add('should_watch_modal_enhanced', {
                ...
                enter: function() {
                    if (window._sw_activeInteractive) $(window._sw_activeInteractive).trigger('click');
                },
                back: function() {
                    cleanupModal();
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v54.0 initialized: v50 blocknav (scrollStep with animate + highlightVisible + keydown capture) on top of v53 design.');
    }
