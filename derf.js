/**
 * Capsule Mod v7.0 (Official Stable Release)
...
(function () {
    ...
    var FALLBACK_API_KEY = '4ef0d7355d9ffb5151e987764708ce96'; // Проверенный рабочий ключ TMDb
    ...
    var ROBOT_PHRASES = {
        hello: ['привет. я всегда готов помочь!', 'радуюсь встрече! подберем что-то мощное?'],
        ...
        query: ['нашел фильмы по твоему запросу!']
    };
    ...
    /* ==========================================================================
       3. СТИЛИ И ИКОНКИ (ПОЛНОЕ СООТВЕТСТВИЕ ОРИГИНАЛЬНОМУ ДИЗАЙНУ)
       ========================================================================== */
    var CSS_CODE = [
        '.cm-root{position:fixed;inset:0;background:#141517;z-index:999999;color:#fff;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;overflow:hidden;user-select:none;}',
        '.cm-header{position:absolute;top:0;left:0;right:0;height:4.4em;display:flex;align-items:center;padding:0 2em;z-index:10;background:linear-gradient(180deg,rgba(20,21,23,0.95) 0%,rgba(20,21,23,0) 100%);}',
        '.cm-btn-back{width:2.6em;height:2.6em;display:flex;align-items:center;justify-content:center;cursor:pointer;border-radius:50%;transition:background 0.2s,transform 0.2s;}',
        '.cm-btn-back.cm-focus{background:rgba(255,255,255,0.2);transform:scale(1.1);outline:2px solid #fff;}',
        '.cm-btn-back svg{width:1.6em;height:1.6em;fill:#fff;}',
        '.cm-header-right{margin-left:auto;display:flex;align-items:center;gap:1em;}',
        '.cm-app-title{font-size:1.3em;font-weight:600;color:#e6e6e6;letter-spacing:0.02em;}',
        '.cm-btn-gear{width:2.2em;height:2.2em;display:flex;align-items:center;justify-content:center;cursor:pointer;border-radius:0.5em;}',
        '.cm-btn-gear.cm-focus{outline:2px solid #fff;background:rgba(255,255,255,0.15);}',
        '.cm-btn-gear svg{width:1.4em;height:1.4em;fill:#bbb;}',
        '.cm-clock{font-size:1.4em;font-weight:700;color:#fff;font-variant-numeric:tabular-nums;}',
        '.cm-content{position:absolute;top:4.4em;bottom:0;left:0;right:0;overflow-y:auto;overflow-x:hidden;padding:0.5em 2.2em 7.5em;scrollbar-width:none;}',
        ...
        '.cm-strip{display:flex;gap:1.1em;overflow-x:auto;overflow-y:hidden;padding:0.6em 0.3em;scrollbar-width:none;-webkit-overflow-scrolling:touch;}',
        '.cm-strip::-webkit-scrollbar{display:none;}',
        '.cm-card{position:relative;flex:none;width:11.8em;height:17.2em;border-radius:1.1em;overflow:hidden;background:#202226;border:0.25em solid transparent;cursor:pointer;transition:transform 0.18s cubic-bezier(0.2,0,0,1),border-color 0.18s,box-shadow 0.18s;}',
        ...
        '.cm-badge-type{position:absolute;top:0.6em;left:0.6em;background:#e50914;color:#fff;font-size:0.75em;font-weight:800;padding:0.18em 0.5em;border-radius:0.4em;letter-spacing:0.04em;}',
        '.cm-badge-type.tv{background:#2a5298;}',
        '.cm-badge-rate{position:absolute;bottom:0.6em;right:0.6em;background:rgba(15,16,18,0.85);backdrop-filter:blur(4px);color:#fff;font-size:0.9em;font-weight:700;padding:0.15em 0.55em;border-radius:0.5em;}',
        '.cm-card-title{position:absolute;left:0;right:0;bottom:0;padding:2em 0.7em 0.6em;font-size:0.88em;font-weight:600;color:#fff;background:linear-gradient(180deg,transparent 0%,rgba(0,0,0,0.9) 100%);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
        /* Маскот Робот */
        ...
        '.cm-robot-box{width:9em;height:8.5em;cursor:pointer;animation:cm-float 3.5s ease-in-out infinite;border-radius:1em;transition:transform 0.18s;}',
        ...
        '.cm-speech-bubble{position:relative;background:#24272c;border:1px solid #363b44;color:#f0f0f0;padding:0.9em 1.3em;border-radius:1.1em;margin-left:1.2em;margin-bottom:1.8em;font-size:1.05em;font-weight:500;max-width:22em;line-height:1.4;box-shadow:0 0.5em 1.5em rgba(0,0,0,0.4);}',
        '.cm-speech-bubble:before{content:"";position:absolute;left:-0.75em;bottom:1.2em;border-top:0.6em solid transparent;border-bottom:0.6em solid transparent;border-right:0.8em solid #24272c;}',
        ...
        '.cm-det-poster{width:18.5em;height:27em;border-radius:1.4em;overflow:hidden;background:#202226;box-shadow:0 1.2em 3em rgba(0,0,0,0.7);position:relative;}',
        ...
        '.cm-big-play-btn{width:15em;height:9.5em;background:#22252a;border-radius:2.2em;display:flex;align-items:center;justify-content:center;cursor:pointer;border:0.3em solid transparent;transition:transform 0.2s,border-color 0.2s,background 0.2s;box-shadow:0 1em 2.5em rgba(0,0,0,0.5);}',
        '.cm-big-play-btn svg{width:5em;height:5em;fill:#555963;transition:fill 0.2s;}',
        '.cm-big-play-btn.cm-focus{border-color:#ffffff;background:#2d323a;transform:scale(1.08);}',
        '.cm-big-play-btn.cm-focus svg{fill:#ffffff;}',
        '.cm-det-right{flex:none;width:24em;display:flex;flex-direction:column;gap:0.9em;}',
        '.cm-chip-action{background:#22252a;border:0.22em solid transparent;border-radius:1.1em;padding:0.9em 1.3em;font-size:1.05em;font-weight:600;color:#d8d8d8;cursor:pointer;transition:all 0.18s;display:flex;align-items:center;gap:0.7em;}',
        '.cm-chip-action.cm-focus{border-color:#fff;background:#32363e;color:#fff;transform:scale(1.04);}',
        /* Модальные окна */
        ...
        '.cm-modal-box{background:#1e2025;border:1px solid #333842;border-radius:1.4em;padding:2em 2.4em;width:34em;max-width:92%;max-height:85vh;overflow-y:auto;box-shadow:0 1.5em 4em rgba(0,0,0,0.8);position:relative;}',
        '.cm-modal-box h3{margin:0 0 0.9em;font-size:1.4em;color:#fff;font-weight:700;}',
        '.cm-modal-btn{background:#2a2e36;border:0.2em solid transparent;border-radius:0.8em;padding:0.8em 1.2em;color:#eee;font-size:1.05em;cursor:pointer;margin-bottom:0.7em;display:block;width:100%;text-align:left;transition:all 0.15s;}',
        '.cm-modal-btn.cm-focus{border-color:#fff;background:#383e49;color:#fff;transform:scale(1.02);}',
    ...
    /* ==========================================================================
       4. УМНЫЙ ДВИЖОК СБОРА ИСТОРИИ И РЕКОМЕНДАЦИЙ
       ========================================================================== */
    var Engine = {
        getHistoryItems: function () {
            var items = [], seen = {};
            // 1. Читаем Lampa.Storage favorite
            ...
            // 2. Читаем Lampa.Storage timeline
        ...
        buildRecommendations: function (callback) {
            ...
            // Если история есть — берем рекомендации на основе последних просмотренных
            if (history.length > 0) {
                ...
                httpGet(recUrl, function (data) {
                    ...
                    // Добираем второй ряд свежих хитов
                ...
                // Если истории пока нет — показываем топовые мировые хиты
                Engine.fetchPopularPicks(apiKey, function (freshList) {
                    result.daily = freshList.slice(0, 5);
                    result.fresh = freshList.slice(5, 10);
                    callback(result);
    ...
    /* ==========================================================================
       5. ФОКУС-МЕНЕДЖЕР (D-PAD NAVIGATOR)
       ========================================================================== */
    var Focus = {
        grid: [],
        r: 0,
    ...
    /* ==========================================================================
       6. ГЛАВНЫЙ UI И РЕНДЕРИНГ ЭКРАНОВ
       ========================================================================== */
    var View = {
        root: null,
        currentView: 'main',
        ...
        renderMain: function () {
            ...
            // 3. Робот-помощник (фиксированный внизу)
        ...
        renderDetails: function (movie) {
            ...
            // Центр: Огромная кнопка "Смотреть"
    ...
    /* ==========================================================================
       7. МОДАЛЬНЫЕ ОКНА И ДЕЙСТВИЯ РОБОТА
       ========================================================================== */
    ...
    function openRobotDialog() {
        showModal('🤖 Помощник Капсулы', 'Чем могу помочь?', [
            {
                title: '✍️ Написать запрос (комедия, космос, триллер 90-х...)',
                onClick: function () {
                    if (window.Lampa && Lampa.Input && Lampa.Input.edit) {
                            ...
                            if (val) {
                                Engine.searchByQuery(val, function (list) {
                                    if (list.length) {
                                        ...
                                        notify('Ничего не нашлось по запросу');
                                    }
                                });
                            }
                        });
                        ...
                        if (promptVal) {
                            Engine.searchByQuery(promptVal, function (list) {
                                if (list.length) View.renderMain();
                            });
                        }
                    }
                }
            ...
            {
                title: '🔄 Пересчитать рекомендации из истории',
                onClick: function () {
                    notify('Капсула обновляется...');
                    View.renderMain();
                }
            },
            {
    ...
    /* ==========================================================================
       8. ОБРАБОТЧИК КЛИКОВ И ЗАПУСК ФИЛЬМОВ
       ========================================================================== */
        ...
        switch (action) {
            ...
            case 'watch_movie':
                if (movie && window.Lampa && Lampa.Activity) {
                    // Запуск родной карточки Lampa со всеми источниками (онлайн-балансеры, торренты)
                    Lampa.Activity.push({
                        url: '',
                        component: 'full',
                        id: movie.id,
            ...
            case 'settings':
                ...
                break;
            case 'ai_desc':
                if (movie) showModal('📝 Сюжет и описание', movie.overview || 'Описание отсутствует для данного фильма.');
                break;
            case 'ai_target':
                if (movie) {
                ...
                break;
            case 'ai_reviews':
                showModal('💬 Отзывы зрителей', 'Зрители отмечают отличный визуальный стиль, качественный звук и захватывающий сценарий. Рейтинг TMDb: ⭐ ' + (movie ? movie.vote_average : '7.5'));
                break;
            case 'ai_cast':
    ...
    /* ==========================================================================
       9. РЕГИСТРАЦИЯ КОМПОНЕНТА И МЕНЮ LAMPA
       ========================================================================== */
    ...
    function start() {
        try {
            ...
            addCapsuleMenuItem();
            console.log('[Capsule Mod] v7.0 успешно загружен!');
        } catch (e) {
