(function () {
    ...
    function analyze(rawMovie) {
        ...
        return Promise.all([loadCredits(movie), loadMeta(movie), Promise.resolve(lampaLocal(movie))]).then(function(arr){
            ...
            if (dEpic.k || dEpic.o) add('tmdb','pro','🏛 Эпическая история', 12, 'epic');
            if (dRevenge.k || dRevenge.o) add('tmdb','pro','⚔️ История мести и интриг', 10, 'revenge');
            ...
            if (mPace >= 8.0) add('moods','pro','⚡ Невероятно динамично', 14);
            ...
            else if (mPace <= 4.5) add('moods','con','🐢 Неторопливое повествование', 8);

            if (mFear >= 8.0) add('moods','con','😱 Экстремально высокое напряжение', 16);
            else if (mFear >= 7.0) add('moods','pro','🔥 Очень напряжённый сюжет', 14);
            else if (mFear >= 6.0) add('moods','pro','🔥 Напряжённый сюжет и саспенс', 12);
            else if (mFear >= 5.0) add('moods','pro','🔍 Есть интрига и напряжение', 8);
            else if (mFear <= 3.5 && !gComedyN) add('moods','con','😌 Практически нет напряжения', 8);

            if (mDrama >= 8.0) add('moods','pro','😢 Очень сильные эмоции', 14);
            else if (mDrama >= 7.0) add('moods','pro','😢 Сильные эмоции и глубокая драма', 12);
            else if (mDrama >= 6.0) add('moods','pro','🎭 Трогательный и эмоциональный', 10);
            else if (mDrama >= 5.0) add('moods','pro','🎭 Есть эмоциональная глубина', 8);
            else if (mDrama <= 3.5) add('moods','con','😐 Слабо выраженные эмоции', 8);

            if (mImmersion >= 8.5) add('moods','pro','🌌 Полное погружение в атмосферу', 16);
            else if (mImmersion >= 7.5) add('moods','pro','🌌 Отличная атмосфера и визуал', 14);
            else if (mImmersion >= 6.5) add('moods','pro','✨ Хорошая атмосфера и детализация', 12);
            else if (mImmersion >= 5.5) add('moods','pro','✨ Приятная атмосфера', 8);
            else if (mImmersion <= 4.0) add('moods','con','😑 Атмосфера слабо выражена', 8);
            ...
            if (dEpic.k || dEpic.o || gHistoricN) {
                aud(9, 'любителям масштабных эпосов и исторических саг', 'тем, кто предпочитает современность и бытовые сюжеты');
                aud(8, 'ценителям зрелищных битв и эпохальных сражений', 'зрителям, которым скучны долгие исторические экспозиции');
                aud(7, 'фанатам историй о чести, мести и предательстве', 'тем, кто не любит пафос и высокопарные диалоги');
            }
            if (isAnim && familyOK) {
