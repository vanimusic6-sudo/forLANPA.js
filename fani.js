...
(function () {
    ...
    function closest(node, selector) {
        while (node && node !== document) {
            ...
            if (node.getAttribute &&
                selector.charAt(0) === '[' &&
                node.getAttribute(selector.slice(1, -1))) {
                return node;
            }
    ...
    var Engine = {
        ...
        discoverByGenres: function (genres, callback) {
            ...
            /*
             * TMDB with_genres=1,2 работает как AND.
             * Поэтому несколько жанров ищем отдельными запросами
