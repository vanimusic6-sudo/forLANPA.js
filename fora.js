 ...
 * - Всё остальное из v14: трей в карточке, темы, робот, пульт/сенсор
 */
...
(function () {
    ...
    const CSS = `
        ...
        .cm-hero{flex:1;min-width:0;width:100%;display:flex;flex-direction:column}
        ...
        @media (max-width:760px){
            ...
            .cm-hero-poster{width:8em;height:12em;margin:0 .9em 0 0}
            .cm-name{font-size:1.4em}
            .cm-why{font-size:.85em;max-width:none;margin-bottom:.6em}
            .cm-act{flex:1 1 45%;justify-content:center;padding:.75em .6em;font-size:.95em;margin:0 .4em .4em 0}
...
<linearGradient id="gA2" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#F8FAFF"/><stop offset="1" stop-color="#B9C6DC"/></linearGradient>
    ...
    // === 16. КОМПАНЬОН (v14.2: нужное сверху, лишнее — в «Ещё») ===
    const Companion = {
        open: () => {
    ...
    (() => {
        try {
            ...
            addMenu();
            console.log('[Капсула] v14.2 загружена');
        } catch (e) {
