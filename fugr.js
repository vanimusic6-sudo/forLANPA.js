...
function openFullCard(m) { try { Lampa.Activity.push({ url: '', component: 'full', id: m.id, method: m.type, card: m, source: 'tmdb' }); } catch (e) { notify('Не удалось открыть карточку Lampa'); } }/* --- CAPSULE MOD v2 PART 5/6 --- */
