 ...
 * Version: 52.4 (Fixed button visibility, improved insertion, dice shake)
...
(function () {
            ...
            if (window.Lampa && Lampa.Modal && typeof Lampa.Modal.open === 'function') {
                Lampa.Modal.open({
                    ...
                    onBack: function(){
                        ...
                        window._sw_closed = true;
                        cleanupModal();
                        // Lampa сама закроет модалку при возврате
                    }
                });
            }
    ...
    function startPlugin() {
        ...
        // Улучшенный обработчик появления карточки
        try {
                ...
                Lampa.Listener.follow('full', function(e){
                    ...
                    try {
                        ...
                        if (!renderEl || !renderEl.length) {
                            // Fallback: попытаться найти общий контейнер
        ...
        console.log('[ShouldWatch] v52.4 initialized: fixed button visibility, dice shake, improved UI.');
    }
