 ...
 * Version: 52.5 (Full D-Pad Controller & Remote Navigation, Clean Modal Lifecycle, Zero Memory Leaks)
...
(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dicebtn.focus{background:#2f353a!important;transform:scale(1.02);box-shadow:0 0 0 2px rgba(255,255,255,.55), 0 6px 20px rgba(0,0,0,.4)}' +
            ...
            '.sw-tab-btn.focus{opacity:1;background:#384148!important;transform:scale(1.02);box-shadow:0 0 0 2px rgba(255,255,255,.5), 0 2px 8px rgba(0,0,0,.3)}' +
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v52.5 initialized: full D-Pad & remote controller support, safe lifecycle cleanup.');
    }
