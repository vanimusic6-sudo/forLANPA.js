...
(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            // Smooth "knock" bounce (replaces old spin animation)
    ...
    function analyze(rawMovie) {
        ...
        return Promise.all([loadCredits(movie), loadMeta(movie), Promise.resolve(lampaLocal(movie))]).then(function(arr){
            ...
            var cDrugs = (dDrugs.k?70:0)+(dDrugs.o?40:0)+(gCrime?15:0)+(age!==null&&age>=16?10:0); // Было 50/30, теперь 70/40
            ...
            // === Улучшенные эвристики атмосферы ===
            var paceHeuristic = (hasGenre(genres, /action|боевик|приключен|adventure|триллер|thriller/i) ? 8.0 : (runtime > 140 ? 4.5 : 6.0));
