(function () {
    ...
    function injectCSS() {
        try {
            ...
            s.innerHTML =
                ...
                '.sw-label{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;font-family:' + DISPLAY + ';font-size:2.2em;font-weight:800;color:#878c91;letter-spacing:.01em;padding:0 108px;text-align:center;white-space:nowrap;overflow:hidden;opacity:0;transition:opacity .35s ease}' +
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v28.0 (fast dice, fixed back, kids anim)');
    }
