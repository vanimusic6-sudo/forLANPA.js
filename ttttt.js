(function () {
    ...
    function injectCSS() {
        try {
            ...
            s.innerHTML =
                ...
                '.sw-label{font-family:' + DISPLAY + ';font-size:2.2em;font-weight:800;color:#878c91;letter-spacing:.01em;text-align:center;white-space:nowrap;opacity:0;transform:translateX(-20px);transition:opacity .6s ease,transform .6s cubic-bezier(.25,.46,.45,.94)}' +
    ...
    function bindDice(html) {
        ...
        dice.addEventListener('animationend', function(){
            try {
                ...
                dice.style.transition = 'transform .6s cubic-bezier(.34,1.56,.64,1)';
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v30.0 (final polish)');
    }
