...
(function () {
    ...
    const CSS = `
        ...
        @media (hover:hover){.cm-act:hover,.cm-opt:hover,.cm-chip:hover,.cm-bar-btn:hover{background:rgba(255,255,255,.12)}.cm-onb-card:hover{box-shadow:inset 0 0 0 1px var(--cm-accent2)}}
