/**
 * Capsule Mod v17.3 — «Капсула»
 *
 * Изменения в v17.3:
 *  — Добавлена пользовательская настройка вертикального смещения интерфейса
 *    (поднять выше / чуть выше / по умолчанию / чуть ниже / опустить ниже).
 *  — Значение сохраняется в localStorage и применяется через CSS-переменную.
 *  — Все предыдущие улучшения v17.2 сохранены.
 */
(function () {
    'use strict';
