...
(function () {
    ...
    // First tries Lampa's native wheel method, then falls back to direct DOM scroll.
    function scrollModalBy(dir) {
        // 1. Use Lampa's native scroll mechanism — works reliably on TV.
        var sc = modalScroll();
