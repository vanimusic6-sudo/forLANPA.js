...
(function () {
    ...
    var View = {
        ...
        render: function (keepRow) {
            ...
            /* Сохраняем активный ряд при листании (фокус не теряется) */
            if (keepRow === 1 && Nav.rows[1]) Nav.setFocus(1, this.idx, true);
            else Nav.setFocus(0, 0, true);
        ...
        step: function (delta) {
            ...
            this.go(next, Nav.r);   // сохраняем текущий ряд
        }
    };
