 ...
 * Version: 52.1 (Clean UI, simplified animations, mouse support)
...
(function () {
    ...
    function injectCSS() {
        ...
        s.innerHTML =
            ...
            '.sw-dossier{position:relative;background:#1e2226;border:1px solid rgba(255,255,255,.08);border-radius:16px;padding:28px 28px 22px;margin-bottom:16px;box-shadow:0 4px 16px rgba(0,0,0,.3);animation:swRise .4s ease both;overflow:hidden}' +
            '@keyframes swRise{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:translateY(0)}}' +
            '.sw-verdict-word{position:relative;font-size:2.8em;font-weight:700;letter-spacing:.03em;line-height:1;margin:0 0 18px;text-transform:uppercase;opacity:0;transform:translateY(10px);transition:opacity .5s ease,transform .5s cubic-bezier(.2,.8,.2,1)}' +
            ...
            /* ===== Dice button ===== */
            '.sw-dicebtn{position:relative;display:flex;align-items:center;justify-content:center;width:100%;height:88px;border-radius:16px;background:#262b30;border:1px solid rgba(255,255,255,.08);margin:0 0 16px;cursor:pointer;outline:none;transition:transform .2s ease,box-shadow .2s,background .2s;-webkit-tap-highlight-color:transparent;box-shadow:0 4px 12px rgba(0,0,0,.25)}' +
            '.sw-dicebtn.focus{box-shadow:0 0 0 2px var(--sw-gold),0 8px 20px rgba(0,0,0,.4);transform:scale(1.01);background:#2b3136}' +
            '.sw-dicebtn:active{transform:scale(.98)}' +
            '.sw-dice{position:absolute;left:16px;top:50%;width:56px;height:56px;margin-top:-28px;transition:transform .3s ease;filter:drop-shadow(0 4px 6px rgba(0,0,0,.4))}' +
            '.sw-dice-core{display:block;width:100%;height:100%}' +
            '.sw-dice-core svg{width:100%;height:100%;display:block}' +
            '.sw-dice.sw-spin .sw-dice-core{animation:swSpin .8s cubic-bezier(.3,.8,.4,1) forwards}' +
            '@keyframes swSpin{0%{transform:rotate(0)}100%{transform:rotate(720deg)}}' +
            '.sw-dice-label{position:relative;font-size:1.6em;font-weight:600;color:#fff;text-align:center;transition:opacity .25s ease,transform .25s ease;pointer-events:none;padding:0 16px}' +
            ...
            /* ===== Tabs ===== */
            '.sw-tabs{display:grid;grid-template-columns:1fr 1fr;background:#1e2226;border-radius:12px;overflow:hidden;margin-bottom:16px;padding:3px;gap:3px}' +
            '.sw-tab-btn{position:relative;min-height:48px;padding:10px 8px;display:flex;align-items:center;justify-content:center;gap:8px;background:transparent;border:none;outline:none;border-radius:10px;cursor:pointer;color:#c7cdd2;font-size:0.95em;font-weight:600;text-transform:none;opacity:.6;transition:opacity .2s,background .2s ease,transform .15s;user-select:none}' +
            '.sw-tab-btn.active{opacity:1;color:#fff;background:#2d3338;box-shadow:0 2px 8px rgba(0,0,0,.25)}' +
            '.sw-tab-btn.focus{opacity:1;box-shadow:0 0 0 2px var(--sw-gold);transform:scale(1.01)}' +
            '.sw-tab-btn.sw-disabled{opacity:.35;pointer-events:none}' +
            '.sw-tagplus{background:#33e08a;border:none;color:#04150c;padding:2px 12px;font-weight:700;text-transform:uppercase;border-radius:6px;font-size:.8em}' +
            '.sw-tagminus{background:#ff5b6e;border:none;color:#180307;padding:2px 12px;font-weight:700;text-transform:uppercase;border-radius:6px;font-size:.8em}' +
            ...
            '.sw-col{position:relative;background:#1e2226;border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:20px 22px;box-shadow:0 4px 12px rgba(0,0,0,.25)}' +
            ...
            '.sw-list li{position:relative;margin-bottom:12px;padding-left:0;opacity:0;transform:translateY(6px);transition:opacity .4s ease,transform .4s ease}' +
            ...
            '.sw-metric-card{position:relative;background:#1e2226;border:1px solid rgba(255,255,255,.06);border-radius:12px;padding:14px 16px;box-shadow:0 4px 12px rgba(0,0,0,.2);transition:transform .2s ease}' +
            '.sw-metric-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px}' +
            '.sw-metric-name{font-size:.8em;font-weight:600;color:#c7cdd2;text-transform:uppercase;letter-spacing:.03em}' +
            '.sw-metric-score{font-size:1.1em;font-weight:700;letter-spacing:.02em}' +
            '.sw-metric-score.hi{color:#ff8a95}.sw-metric-score.mid{color:#ffc266}.sw-metric-score.ok{color:#5fe6a0}' +
            '.sw-metric-bar-bg{height:6px;border-radius:4px;background:rgba(255,255,255,.07);overflow:hidden;margin-bottom:6px}' +
            '.sw-metric-bar-fill{height:100%;border-radius:4px;transition:width .8s ease}' +
            '.sw-metric-desc{font-size:.72em;color:#8b98a5;line-height:1.35}' +
            '.sw-audience-box{position:relative;background:#1e2a23;border:1px solid rgba(51,224,138,.25);border-radius:12px;padding:16px 20px;box-shadow:0 4px 12px rgba(0,0,0,.2);margin-top:12px;overflow:hidden}' +
            '.sw-audience-title{font-size:.8em;font-weight:700;text-transform:uppercase;color:#7fe6ac;letter-spacing:.04em;display:flex;align-items:center;gap:6px;margin-bottom:8px}' +
            '.sw-audience-text{font-size:.9em;line-height:1.5;color:#e6ece8;margin:0}' +
            '.sw-audience-warn{font-size:.82em;line-height:1.4;color:#ffb0b8;margin-top:10px;padding-top:10px;border-top:1px dashed rgba(255,91,110,.3)}' +
            '.sw-focusable{outline:none;cursor:pointer}' +
            '@media(max-width:680px){.sw-columns{grid-template-columns:1fr}.sw-metrics-grid{grid-template-columns:1fr}.sw-verdict-word{font-size:2.2em}.sw-dice-label{font-size:1.4em}.sw-dice{width:44px;height:44px;margin-top:-22px;left:12px}.sw-dossier{padding:20px 16px 16px}}';
    ...
    function bindDice(html) {
        ...
        function rollDice() {
            ...
            setTimeout(function(){ 
                if (document.body.contains(dice[0])) dice.css('transform', 'translateX(0)'); 
            }, 400);
            setTimeout(function(){
                if (document.body.contains(dice[0])) {
    ...
    function startPlugin() {
        ...
        console.log('[ShouldWatch] v52.1 initialized: clean UI, simplified animations, mouse support.');
    }
